...
public class ProviderInitializer {
    ...
    public List<Providers> loadProviders() {
        ...
        providers.add(Providers.builder()
            ...
            .product(ArticleCategory.HARINA)
            .shippingCost(10000D)
        ...
        providers.add(Providers.builder()
            ...
            .product(ArticleCategory.VEGETAL)
            .shippingCost(10000D)
        ...
        providers.add(Providers.builder()
            ...
            .product(ArticleCategory.LACTEO)
            .shippingCost(15000D)
        ...
        providers.add(Providers.builder()
            ...
            .product(ArticleCategory.AZUCAR)
            .shippingCost(20000D)
            ...
            .product(ArticleCategory.ESPECIE)
            .shippingCost(10000D)
        ...
        providers.add(Providers.builder()
            ...
            .product(ArticleCategory.MAICENA)
            .shippingCost(10000L)
        ...
        providers.add(Providers.builder()
            ...
            .product(ArticleCategory.CEREAL)
            .shippingCost(15000D)
